...
| Theme settings | `src/features/settings/{theme,theme-controller,settings-screen}.ts*` | Authenticated users can choose light, dark, device, or StickyStudy-compatible 21:00–06:00 night mode. The choice is stored in the local user database and applied to the document across routes. |
