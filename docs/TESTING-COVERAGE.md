...
| | |
|---|---|
| Unit/integration test files | 36 (253 test cases: 253 passing) |
| Component test files | 9 (`study-screen.test.tsx`, `home-screen.test.tsx`, `history-screen.test.tsx`, `dictionary-screen.test.tsx`, `browse-screen.test.tsx`, `detail-screen.test.tsx`, `settings-screen.test.tsx`, `app-navigation.test.tsx`, `help-screen.test.tsx` — 74 cases, included above) |
...
| `src/data/**` | 85% | db 93.19 / 85.71 / 100 / 93.19 · packs 98.71 / 80.59 / 100 / 98.71 · repo 97.44 / 90.38 / 100 / 97.44 | ✅ comfortable margin |
...
| Global floor | 60% | 86.94 / 84.01 / 89.22 / 86.94 | ✅ comfortable margin |
