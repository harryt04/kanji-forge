...
| 10.3 | Multiple import formats | ✅ | 2026-08-08 | Settings accepts CSV, TSV, line lists, versioned KanjiForge JSON deck exports, and best-effort Anki `.apkg` files; all imports share the matched/already-saved/not-found preview and add content without overwriting progress |
