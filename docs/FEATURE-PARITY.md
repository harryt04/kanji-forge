...
| 4.14 | Native-speaker audio per word | ⚠️ Partial | 2026-08-08 | Kanji and dictionary-word Detail views, plus Study, prefer matching licensed community recordings installed from Settings (MP3, OGG/Opus, WAV, M4A, AAC, FLAC, and WebM) and fall back to labeled device-synthesized Japanese audio; broad human-recorded coverage remains 🔷 — DATA-SOURCES §8 |
