...
| # | Feature | Status | Implemented | Notes |
|---|---|---|---|---|
| 9.1 | Paste Japanese text → readings, furigana, English | ⚠️ Partial | 2026-08-08 | Authenticated `/analyze` provides offline dictionary segmentation over written forms and kana readings with ruby readings, English meanings, and grouped visible unknown-text fallback; a morphological tokenizer pack remains the accuracy upgrade for grammatical segmentation |
