...
| — | Import preview with matched/already-in-target/not-found results | ➕ ✅ | 2026-08-07 | Bare-kanji preview classifies dictionary matches, existing target-deck cards, and missing entries before confirmation; ambiguous word/CSV imports remain future work |
