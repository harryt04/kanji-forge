...
| — | Tablet / laptop / desktop layouts | ➕ 🔷 | 2026-08-08 | Authenticated screens use a persistent left sidebar above `md` and a compact horizontal header on smaller screens. Browse keeps the deck list and selected Detail card in a responsive two-pane view on large screens; Dictionary/Detail remains a follow-up slice |
