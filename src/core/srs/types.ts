...
export function emptyCardState(deckId: string, stickyId: string, updatedBy = ''): CardState {
  return { deckId, stickyId, level: 0, dueAt: null, lastReviewedAt: null, correctStreak: 0, totalReviews: 0, totalCorrect: 0, lapses: 0, flagged: false, manualOverride: false, updatedAt: 0, updatedBy };
}
