...
>(({ className, align = 'start', alignOffset = -4, ...props }, ref) => (
  <MenubarPrimitive.Portal>
    <MenubarPrimitive.Content
      ...
      collisionPadding={8}
      className={cn(
        'border-border bg-popover text-popover-foreground z-50 max-h-[min(70dvh,32rem,var(--radix-menubar-content-available-height))] min-w-48 overflow-x-hidden overflow-y-auto overscroll-contain rounded-md border p-1 shadow-md',
